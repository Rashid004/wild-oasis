...
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-12 lg:gap-24 text-lg items-center">
...
//         <div className="lg:col-span-2 relative aspect-w-16 aspect-h-9">
//           <Image
//             src={image1}
//             alt="Family sitting around a fire pit in front of cabin"
//             layout="fill"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-12 lg:gap-24 text-lg items-center">
        ...
        <div className="lg:col-span-2 relative aspect-w-16 aspect-h-9">
          <Image
            ...
            className="object-cover" // Optional: To ensure image fills the container
          />
        </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div>
              <Link
                href="/cabins"
                className="inline-block mt-4 bg-accent-500 px-6 py-3 md:px-8 md:py-5 text-primary-800 text-base md:text-lg font-semibold hover:bg-accent-600 transition-all"
              >
                Explore our luxury cabins
              </Link>
            </div>
